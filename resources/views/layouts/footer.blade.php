                ...
                <div class="col-lg-8">
                    ...
                    <div class="row col-mb-50">
                        <div class="col-md-4">
                            ...
                            <div class="widget">
                                <p>Porque el camino es <strong>Duro</strong>, nosotros <strong>te acompañamos</strong> para ayudarte a avanzar.</p>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-12">
                            <div class="widget">
                                ...
                                <div class="row col-mb-30">
                                    <div class="col-lg-6">
                                        <div class="counter counter-small"><span data-from="50" data-to="15000" data-refresh-interval="80" data-speed="3000" data-comma="true"></span></div>
                                        <h5 class="mb-0">Ventas totales</h5>
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="counter counter-small"><span data-from="100" data-to="1200" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
        ...
        <div class="container">
            ...
            <div class="row col-mb-30">
                ...
                <div class="col-md-6 text-center text-md-start">
                    Copyrights &copy; 2023 All Rights Reserved by <b>Civantos</b><br>
                </div>
                ...
                <div class="col-md-6 text-center text-md-end">
                    ...
                    <i class="bi-envelope"></i> hernandez.civantos@gmail.com <span class="middot">&middot;</span> <i class="fa-solid fa-phone"></i> +34 666 66 66 66
                </div>
