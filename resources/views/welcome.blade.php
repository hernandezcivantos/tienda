                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="feature-box fbox-plain fbox-dark fbox-sm">
                                ...
                                <div class="fbox-content">
                                    <h3>Original 100%</h3>
                                    <p class="mt-0">Todos nuestros productos son de la marca oficial.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row col-mb-50">
                        ...
                        <div class="col-md-6 mb-5 subscribe-widget">
                            <div class="heading-block">
                                <h3><strong>20% DESCUENTO*</strong></h3>
                                <span>Apúntate a nuestro newsletter y obten hasta un 20% de descuento.</span>
                            </div>
